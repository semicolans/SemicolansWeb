            ...
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-s-12 col-md-2">
                        <div class="form-group">
                            <label></label>
                            <asp:LinkButton ID="btnSearch" CssClass="form-control" Style="margin-top: 8px; width: 40px; cursor: pointer;" runat="server" OnClick="btnSearch_Click">
...
<%--                                            <asp:BoundField DataField="ItemBarcode" HeaderText="ID" SortExpression="ItemBarcode">
                                                    ...
                                                    <div class="conteiner-fluid">
                                                        <div class="row">
                                                            <div class="col-md-9">
                                                                <div class="row">
                                                                    <div class="col-md-12">
                                                                        Code :<asp:Label ID="Label5" runat="server" Font-Bold="True" Text='<%# Eval("ItemBarcode") %>' Font-Size="Small"></asp:Label>
                                                                    </div>
                                                                </div>
                                                                <div class="row">
                                                                    <div class="col-md-12">
                                                                        <asp:Label Style="text-transform: uppercase;" runat="server" ID="lblDtGridItemName" Text='<%# Eval("ItemName") %>' Font-Bold="True" Font-Size="Large" ForeColor="#FF9933"></asp:Label>
                                                                    </div>
                                                                </div>
                                                                <div class="row">
                                                                    <div class="col-md-12">
        ...
        <div id="FixedFooter">
            <div class="conteiner-">
                <div class="row" style="height: 100px; float:right;">
                    <div class="pt-2 pr-1">
                        <asp:Label ID="lblNoOfItems" class="btn btn-success" runat="server" Text="No Of Items"></asp:Label>
                    </div>
                    <div class="pt-2 pr-1">
                        <asp:Label ID="lblTotalQtyRemain" class="btn btn-warning" runat="server" Text=""></asp:Label>
                    </div>
                    <div class="pt-2 pr-1">
                        <asp:Label ID="lblCostValue" class="btn btn-danger" runat="server" Text=""></asp:Label>
                    </div>
                    <div class="pt-2 pr-1">
                        <asp:Label ID="lblSalesValue" class="btn btn-success" runat="server" Text=""></asp:Label>
                    </div>
                </div>
            </div>
        </div>
