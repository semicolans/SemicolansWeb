<%@ Page Title="" Language="C#" MasterPageFile="~/UserSite/User.Master" AutoEventWireup="true" CodeBehind="CustomerRegistrationForm.aspx.cs" Inherits="eCommerce.UserSite.WebForm5" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
   <script type="text/javascript">
       ...
       function FillTextBox(dropdown) {
           var textbox = document.getElementById('<%=txtCountryCode.ClientID %>');
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container pt-2">
        <div class="row">
            ...
            <div class="col-md-5" style="border: 1px solid rgba(0, 0, 0, 0.125); border-radius: 10px 10px 10px 10px; margin-top: 20px;margin-bottom:20px;">

                <br />
                <h1 class="section-title">Register</h1>
                <p>If you register to E Shop you will be able to take benefit from our promotions and discounts</p>
                <br />
                <p>(*) Required Fields</p>
                <br />
                <div class="row">
                ...
                <div class="row pl-3">
                    <div class="form-group">
                        <p style="margin-left:15px;">Country Code</p>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-5">
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            <asp:TextBox CssClass="form-control" ID="txtCountryCode" ReadOnly="True"  Style="text-transform: capitalize;" runat="server" placeholder="+94"></asp:TextBox>
                        </div>
                    </div>
                    <div class="col-md-5">
                        <div class="form-group">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <p>Password*</p>
                            <asp:TextBox CssClass="form-control" ID="txtPassword" Type="password"  runat="server" placeholder="Password"></asp:TextBox>
                        </div>
                    </div>        
                   <div class="col-md-6">
                        <div class="form-group">
                            <p>Confirm Password*</p>
                            <asp:TextBox CssClass="form-control" ID="txtConfirmPassword" Type="password" runat="server" placeholder="Password"></asp:TextBox>
                        </div>
                    </div>
                </div>
                <p><i>Password must be of minimum length 8-12 and must has at least 1 digit and 1 character</i></p>
                ...
                <div class="row pt-3 pb-3">
                    <div class="col-md-6 pull-left">
                        <asp:Button ID="btnAdd" class="btn btn-block btn-success" runat="server" Text="Register" OnClick="btnAdd_Click" />
                    </div>
                    <div class="col-md-6 pull-right">
                        <p>Already Have Account ? <a style="color:blue;" href="CustomerLogin.aspx">Login</a> </p>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
